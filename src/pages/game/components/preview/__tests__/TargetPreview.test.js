...
describe('TargetPreview', () => {
  ...
  it('strips the localhost host from the iframe src', () => {
    render(
      <TargetPreview
        targetUrl="http://localhost:5000/pages/level-01/"
        levelTitle="The First Test"
      />
    );
  ...
  it('strips localhost with any port number', () => {
    render(
      <TargetPreview
        targetUrl="http://localhost:3000/pages/level-77/"
        levelTitle="Level 77"
      />
    );
  ...
  it('strips https:// localhost as well', () => {
    render(
      <TargetPreview
        targetUrl="https://localhost:8080/pages/level-10/"
        levelTitle="Level 10"
      />
    );
  ...
  it('renders an iframe with the correct title', () => {
    render(
      <TargetPreview targetUrl="http://localhost:5000/pages/level-01/" levelTitle="Selector Basics" />
    );
  ...
  it('applies sandbox restrictions to the iframe', () => {
    render(
      <TargetPreview targetUrl="http://localhost:5000/pages/level-01/" levelTitle="Level 01" />
    );
  ...
  it('renders the level title in the preview header', () => {
    render(
      <TargetPreview targetUrl="http://localhost:5000/pages/level-01/" levelTitle="The Selector Sage" />
    );
  ...
  it('open-in-new-tab link href uses the stripped path', () => {
    render(
      <TargetPreview targetUrl="http://localhost:5000/pages/level-42/" levelTitle="Level 42" />
    );
    const link = screen.getByTitle('Open in new tab');
